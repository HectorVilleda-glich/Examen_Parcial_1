...
export function AuthLayout({ title, subtitle, children, footer, variant = "login" }: AuthLayoutProps) {
  return (
    <div className="flex min-h-screen">
      <aside className="hidden w-1/2 flex-col justify-between bg-gradient-to-br from-[#007bd2] to-[#0066b3] p-12 text-white lg:flex">
        <div>
        ...
        <p className="text-sm text-blue-100/80">
          Plataforma inspirada en Workana &middot; Examen I
        </p>
      </aside>
